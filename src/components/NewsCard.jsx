        ...
        <div>
            <div className="bg-white flex flex-col h-[520px] md:w-[350px] lg:w-[320px] xl:w-[380px] font-plusSans border-gray-400 rounded-lg shadow-md">
                <div className="image h-56 w-full">
                    <img src={item.urlToImage} alt={item.title} className="object-cover rounded-t-lg h-full w-full" />
                </div>

                <div className="px-5 py-3 pb-5">
                    <span className='text-base bg-purple-200 px-4 py-1 mb-4 rounded-sm'>{item.source.name}</span>
